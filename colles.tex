...
\tcolorboxenvironment{exo}{% `proof' from `amsthm' 
enhanced,colframe=blue!10!black,colback=black!2!red!1!white,
      coltitle=red!20!black!70,fonttitle=\upshape\bfseries,fontupper=\itshape,boxrule=0.4pt,arc=0mm}

\tcolorboxenvironment{sol}{%
      blanker,breakable,left=5mm,
before skip=10pt,after skip=10pt,
borderline west={0.5mm}{0pt}{blue!20!black!40}}
...
\fancyhead[L]{\hyperref[sec:contents]{\small Khôlles en Mathématiques en MPI*}}
...
\title{\Huge \bfseries Exercices de Khôlle en Mathématiques\\ 
\huge MPI*}

% --- Author and date of last update ---

\author{\normalsize Lycées Paul Valéry et Hoche}
